<%-- 
    Document   : register
    Created on : Jun 6, 2020, 7:53:24 PM
    Author     : Om prakash
--%>
...
<p>
    ...
    <option> What was the last name of your favourite teacher?</option>
...
<br>
<button type="submit" value="User Registered" name="register">Register</button>
                   <a href="clientlogin.jsp">Already have Account?</a>
                </form>
</div>
</div>
</body>
